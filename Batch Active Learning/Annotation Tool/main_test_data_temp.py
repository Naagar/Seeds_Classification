...
ordered_file_name_list = [paths_of_images[i].split('/')[-1] for i in range(len(paths_of_images))]
        ...
        dbc.CardBody([
            dcc.RadioItems(
                ...
                options=[
                    ...
                    {'label': '2nd label', 'value': "1"},
                    {'label': '3rd Label', 'value': "2"},
                    {'label': 'Silkcut', 'value': "3"}
