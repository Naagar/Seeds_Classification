...
black_button_style = {'background-color': 'white',
                      'color': 'black',
                      'height': '50px',
                      'width': '100px',
                      'margin-top': '50px',
...
def card_body(card_id):
 ...
 # dbc.CardImg(id = f'cardimg_id_{card_id}', src=paths_of_images[card_id] ,  top=True, style={"height": "125px", "width": "188px"}, n_clicks=0),
    ...
    return [
        dbc.CardImg(src=paths_of_images[card_id] ,  top=True, style={"height": "125px", "width": "160px", 'z-index':'3'}, id = {'type':'CardImg', 'index':f'{card_id}'} ),
        dbc.CardBody([
            dcc.RadioItems(
                id={
                    'type': 'label-option',
                ...
                labelStyle={'display': 'inline-block', 'color':'black', "padding": "0px 1px 0px 1px", "margin": "1px", 'fontsize':'1px'},
...
@app.callback(
    ...
    [Input(component_id={'type':'btncard', 'index':MATCH}, component_property='n_clicks'),
    Input(component_id={'type':'btncard', 'index':MATCH}, component_property='id')],
    prevent_initial_call = True
)
...
def button_click(value, id):
    ...
    # id['index'] is the image_id and value is what's entered by user 
    # Make Changes on id[index] for value element . Can you do it?


    
    return {'display': 'inline-block', 'color':'red', "padding": "0px 1px 0px 1px", "margin": "1px", 'fontsize':'1px'}
