...
def G_arch(ch=64, attention='64', ksize='333333', dilation='111111'):
  ...
  arch[64]  = {'in_channels' :  [ch * item for item in [16, 16, 8, 4]],
               ...
               'attention' : {2**i: (2**i in [int(item) for item in attention.split('_')])
                              for i in range(3,7)}}
  # 48 like 64
  arch[48]  = {'in_channels' :  [ch * item for item in [16, 16, 8, 4]],
              'out_channels' : [ch * item for item in [16, 8, 4, 2]],
              'upsample' : [True] * 4,
              'resolution' : [6, 12, 24, 48],
              'attention' : {3*2**i: (3*2**i in [int(item) for item in attention.split('_')])
                              for i in range(1,5)}}
...
def D_arch(ch=64, attention='64',ksize='333333', dilation='111111'):
  ...
  arch[128] = {'in_channels' :  [3] + [ch*item for item in [1, 2, 4, 8, 16]],
               ...
               'attention' : {2**i: 2**i in [int(item) for item in attention.split('_')]
                              for i in range(2,8)}}
  arch[96]  = {'in_channels' :  [3] + [ch*item for item in [1, 2, 4, 8, 16]],
               'out_channels' : [item * ch for item in [1, 2, 4, 8, 16, 16]],
               'downsample' : [True] * 5 + [False],
  ...
  arch[64]  = {'in_channels' :  [3] + [ch*item for item in [1, 2, 4, 8]],
               ...
               'attention' : {2**i: 2**i in [int(item) for item in attention.split('_')]
                              for i in range(2,7)}}
  # resolution line might be messed up?
  arch[48]  = {'in_channels' :  [3] + [ch*item for item in [1, 2, 4, 8]],
               'out_channels' : [item * ch for item in [1, 2, 4, 8, 16]],
               'downsample' : [True] * 4 + [False],
